...
## Features 📄
   ...
   - **.vscode:** Contains a `settings.json` file with source paths. This allows users to run all files from the root directory. Several of the Java projects contain path directories with this in mind, so trying to run the files any other way will require code and path changes.
